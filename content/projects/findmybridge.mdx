...
- Develop a user registration method using an ethereum wallet.
...
- Grow the traffic of the app from 0 to 11K monthly visits. December 2023 traffic data.
- Improvement of the app monetization thanks to in-house analytics.
- 99/100 performance evaluation using Vercel analysis tool.
- Improvement of fast website loading. First Contentful paint (0.69s), Largest Contentful Paint (0.49s), Cumulative Layout Shift (0.034).