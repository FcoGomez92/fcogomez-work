...
- Grow the traffic of the app from 0 to over 11K monthly users thanks to improvements in SEO strategy.
- Improvement of the app monetization thanks to in-house analytics.
- 99/100 performance evaluation using Vercel analysis tool.
- Improvement of Page Speed Metrics. FC Paint (0.69s), LC Paint (0.49s), CLS (0.034).